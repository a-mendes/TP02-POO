...
public class Relatorio {
	public static void relatorioEspecifica(ArrayList<Livro> livros/*, String[] stringGeral, int itemSelecionado[]*/){
		...
		try {
		    ...
		    writer.write("ESPECIFICAÇÕES DA PESQUISA ESPECIFICA\n");
	...
	public static void relatorioGeral(ArrayList<Livro> livros/*, String stringGeral, int valorNumerico*/){
		...
		try {
		    BufferedWriter writer = new BufferedWriter(new FileWriter(caminhoArquivoPadrao));
		    writer.write("ESPECIFICAÇÕES DA PESQUISA GERAL\n");
